const questions = [
  {
    ...
    image: "https://tse3.mm.bing.net/th/id/OIP.2kt5m_C0IsqX67vvK67pbAHaHa?rs=1&pid=ImgDetMain&o=7&rm=3",
  ...
  {
    text: "¿Que objeto es este?",
    image: "https://tse1.mm.bing.net/th/id/OIP.8r0dDnl6DA_t3hddAAf-dwHaGY?rs=1&pid=ImgDetMain&o=7&rm=3",
  ...
  },
  {
    ...
    image: "https://tse3.mm.bing.net/th/id/OIP.3PdPsH5D2ytfpNLBzCqxzAHaFj?rs=1&pid=ImgDetMain&o=7&rm=3",
  ...
  },
  {
    ...
    image: "https://tse2.mm.bing.net/th/id/OIP.8YtQnJ6hOKrGINKUmf6oiQHaJ6?rs=1&pid=ImgDetMain&o=7&rm=3",
    options: ["Sthephen Hawking", "Albert Einstein", "Nikola Tesla", "Galileo Galilei"],
    correct: 0
  },
  {
  ...
  },
  {
    ...
    options: ["Ingenieria Quimica", "Ingenieria en Sistemas de Informacion", "Ingenieria Electromecanica", "Licenciatura en Administracion de Empresas"],
    correct: 2
  },
  {
    text: "¿Donde estuvo funcionando la facultad antes de tener su edificio propio?",
    options: ["En una fabrica", "En un galpon universitario", "En la municipalidad", "En la escuela Normal Sarmiento"],
    correct: 3
  },
  {
  ...
  },
  {
    ...
    options: ["Ingenieria Quimica", "Ingenieria en Sistemas de Informacion", "Ingenieria Electromecanica", "LAR"],
    correct: 0
  },
  {
    text: "¿De que carrera se suele pensar que todos saben arreglar autos o lavarropas?",
    options: ["Ingenieria Quimica", "Ingenieria en Sistemas de Informacion", "Ingenieria Electromecanica", "Licenciaturas"],
    correct: 2
  },
  {
